      ...
      <div className="modal-content">
        ...
        <div className="address mentee-info-response-box">
          ...
          <div className="address1">
            <div className="mentee-info-response-body">
              <p className="mentee-info-response-text">
                {mentee.streetAddress}
              </p>
          ...
          <div className="state">
            <div className="mentee-info-response-body">
              ...
              <p className="mentee-info-response-subtext">
        ...
        <div className="assistance-areas mentee-info-response-box">
          <h1 className="mentee-info-response-title">
            This child is being referred for assistance in the following areas
          </h1>
        ...
        <div className="interests mentee-info-response-box">
          <h1 className="mentee-info-response-title">
            What particular interests, either in school or out, do you know this
            child has?
          </h1>
          <div className="mentee-info-response-body-lg">
            <p className="mentee-info-response-text">
              {mentee.interests?.reduce((p, c, i) => {
                return i == 0 ? c : `${p}, ${c}`;
              })}
            </p>
          </div>
        ...
        <div className="strategies mentee-info-response-box">
          <h1 className="mentee-info-response-title">
            What words best describe the child?
          </h1>
          <div className="mentee-info-response-body-lg">
            <p className="mentee-info-response-text">
              {mentee.bestDescribes?.reduce((p, c, i) => {
                return i == 0 ? c : `${p}, ${c}`;
              })}
            </p>
          </div>
        ...
        <div className="subjects mentee-info-response-box">
          <h1 className="mentee-info-response-title">
            With what specific academic subjects, if any, does the child need
            assistance?
          </h1>
          <div className="mentee-info-response-body-lg">
        ...
        <div className="old-mentors mentee-info-response-box">
          <h1 className="mentee-info-response-title">Past Mentors:</h1>
          <div className="mentee-info-response-body-altered">
            <p className="mentee-info-response-text">
              {mentee.oldMentorsList?.map((oldMentor) => {
                if (oldMentor.notes) {
                  return oldMentor.name + ": " + oldMentor.notes + "\n";
                } else {
