...
const Interview: React.FC<Props> = ({ data, interviewTime, applicant }) => {
  ...
  const handleClick = async (): Promise<void> => {
    if (!isSaved) {
      try {
        await NetworkManager.makeRequest(Endpoints.UpdateNote, {
          note: note,
  ...
  return (
    <div className="interview-information">
      <div className="scheduling">
        <h2 className="scheduling-text">
          {interviewTime
            ? `Interview Scheduled: ${interviewTime.toDateString()} at ${interviewTime.toLocaleTimeString(
                [],
      ...
      <div className="interview-body-right">
        <div className="notes-container">
          <div className="notes-header">
            ...
            <p className="notes-header-center">
