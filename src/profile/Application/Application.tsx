    ...
    <>
      <div className="response">
        <h1 className="response-title">
          Is there any characteristic in a mentee that you may be uncomfortable
          handling? Please specify.
        </h1>
        <div className="response-body-lg">
          <p className="response-text-lg">{response["14"]["answer"]}</p>
        </div>
      </div>
      ...
      <div className="response">
        ...
        <div className="response-body">
          <input
            type="radio"
            disabled
            checked={response["39"]["answer"] === "Yes"}
          />
          <p className="radio-text">Yes</p>
          <input
            type="radio"
            disabled
            checked={response["39"]["answer"] === "No"}
          />
      ...
      <div className="response">
        ...
        <div className="response-body">
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Monday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Tuesday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Wednesday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Thursday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Friday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Saturday")
            }
          />
          ...
          <input
            ...
            checked={
              response["43"]["answer"] &&
              response["43"]["answer"].includes("Sunday")
            }
          />
      ...
      <div className="response">
        ...
        <div className="response-body">
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "0-1"}
          />
          <p className="radio-text">0-1</p>
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "1-2"}
          />
          <p className="radio-text">1-2</p>
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "2-3"}
          />
          <p className="radio-text">2-3</p>
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "3-4"}
          />
          <p className="radio-text">3-4</p>
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "4-5"}
          />
          <p className="radio-text">4-5</p>
          <input
            type="radio"
            disabled
            checked={response["19"]["answer"] === "5 or more"}
          />
      ...
      <div className="response">
        ...
        <div className="response-body">
          <input
            type="checkbox"
            disabled
            checked={response["9"]["answer"] && response["9"]["answer"]["0"]}
          />
          <p className="radio-text">Elementary</p>
          <input
            type="checkbox"
            disabled
            checked={response["9"]["answer"] && response["9"]["answer"]["1"]}
          />
          <p className="radio-text">Middle School</p>
          <input
            type="checkbox"
            disabled
            checked={response["9"]["answer"] && response["9"]["answer"]["2"]}
          />
          ...
          <input
            ...
            disabled
            checked={
              response["9"]["answer"] && response["9"]["answer"]["other"]
            }
          />
      ...
      <div className="response">
        ...
        <div className="response-body">
          <input
            type="radio"
            disabled
            checked={response["20"]["answer"] === "Yes"}
          />
          <p className="radio-text">Yes</p>
          <input
            type="radio"
            disabled
            checked={response["20"]["answer"] === "No"}
          />
          <p className="radio-text">No</p>
        </div>
      </div>
      ...
      <div className="response">
        <h1 className="response-title">
          Will you agree to have Y-KNOT Inc. check your background through
          federal and state agencies for criminal records and child abuse and
          neglect proceedings?
        </h1>
        <div className="response-body">
          <input
            type="radio"
            disabled
            checked={response["21"]["answer"] === "Yes"}
          />
          <p className="radio-text">Yes</p>
          <input
            type="radio"
            disabled
            checked={response["21"]["answer"] === "No"}
          />
          <p className="radio-text">No</p>
        </div>
      </div>
